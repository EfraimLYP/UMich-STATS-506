...
deal_poker_round <- function(num_players) {
  ...
  # Shuffle the deck
  set.seed(506)  # This line is added by myself to make the results deterministic
...
As for the warning "Warning: longer object length is not a multiple of shorter object length", I'm still working on it.
